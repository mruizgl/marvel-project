...
public class HeroesTest {
    ...
    @Test
    public void updateNoExisteHeroeTest () {
        Personaje personaje = new Personaje("Hola", "test", "test", poderes);
        System.out.println(heroes.getPersonajes().size());
        boolean resultado;
        resultado = heroes.updateHeroe(personaje);
        Assertions.assertFalse(resultado, "El heroe no existe");
    }
